...
This is a drop-in replacement for your backend. Your supplied `ui.html` was not edited.
...
\# Put your GROQ\_API\_KEY in .env
...
To make New chat erase backend context exactly when the button is clicked requires one small frontend call to `POST /chat/new`. I did not make that change because you explicitly asked not to modify the frontend.
